...
namespace Kamgam.PolygonMaterialPainter
{
    public static class ObjExporter
    {
        ...
        /// <param name="pingAsset"></param>
        /// <returns>A dictionary containing the file name (with extension) and the content as string.</returns>
        public static Dictionary<string, string> SaveMeshAsObj(string filePath, string objectName, Mesh mesh, IList<Material> materials, bool logFilePaths, bool pingAsset = false)
        {
            ...
            foreach (var kv in files)
            {
                ...
                if (pingAsset)
                {
                    var asset = AssetDatabase.LoadAssetAtPath<Object>("Assets/" + subdir + name);
