...
namespace Kamgam.PolygonMaterialPainter
{
    public class Logger
    {
        ...
        public const string Prefix = "Material Painter: ";
		...
		const string changeHint = "\nYou can change the verbosity of logs in the Settings under Tools > Polygon Material Painter > Settings : LogLevel";
