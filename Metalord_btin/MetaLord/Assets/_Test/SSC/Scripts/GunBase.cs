...
abstract public class GunBase : MonoBehaviour
{
    ...
    {        
        ...
        bondLayer = 1 << LayerMask.NameToLayer("MovedObject") | 1 << LayerMask.NameToLayer("GrabedObject");
    ...
    protected void UsedAmmo(Ray _ray, int _ammo)
    {
        ...
        //    float side2 = Vector3.Distance(p0, p2);
            ...
            //triggerObj.layer = LayerMask.NameToLayer("NonInteractObject");
            ...
            //objTrigger.radius = 0.1f;
            //objTrigger.transform.SetParent(hit.transform);
