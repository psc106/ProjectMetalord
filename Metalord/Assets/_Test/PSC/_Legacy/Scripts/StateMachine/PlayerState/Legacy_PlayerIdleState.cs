...
[Obsolete]
public class Legacy_PlayerIdleState : Legacy_StateBase<PlayerStateName>
{
    public Legacy_PlayerValue playerValue;

    public Vector3 preMoveDir;

    public Legacy_PlayerIdleState(PlayerStateName key) : base(key)
    {
    }
    public Legacy_PlayerIdleState(PlayerStateName key, Legacy_PlayerValue value) : base(key)
    {
        playerValue = value;
    }
